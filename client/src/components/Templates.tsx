...
function Sheet({ tmpl, values }: { tmpl: FormTemplate; values: Record<string, string> }) {
  ...
  return (
    <div className={`tmpl-sheet${isHindi ? ' hindi' : ''}`}>
      ...
      {isHindi ? (
        // Hindi letter performa: render ONLY the written text (letterhead +
        // body).  No English meta bar, no English signature boxes, no footer —
        // the officer writes by hand on the printed sheet, kept to one page.
